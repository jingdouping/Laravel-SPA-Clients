...
const SecondCategoryDatatable = () => {
    ...
    renderCell:(params)=>{
      return(
        <div className='cellAction' >
          <Link to={`/admin/secondcategories/${params.row.id}`} style={{textDecoration:'none'}}>
  ...
  return (
    <div className='datatable'>
      ...
      className='datagrid'
        rows={categoryList}
        columns={secondaryCategoryColumns.concat(actionColumn)}
        pageSize={9}
...
export default SecondCategoryDatatable
