...
export default function EditSubProduct(props) {
  ...
  if(image.topimage){
    if(file.topimage){
      ...
      topimage = `http://localhost:8000/${image.topimage}`
    }
  ...
  if(image.image1){
    if(file.image1){
      ...
      image1 = `http://localhost:8000/${image.image1}`
    }
  ...
  if(image.image2){
    if(file.image2){
      ...
      image2 = `http://localhost:8000/${image.image2}`
    }
  ...
  if(image.image3){
    if(file.image3){
      ...
      image3 = `http://localhost:8000/${image.image3}`
    }
  ...
  if(image.image4){
    if(file.image4){
      ...
      image4 = `http://localhost:8000/${image.image4}`
    }
  ...
  if(image.image5){
    if(file.image5){
      ...
      image5 = `http://localhost:8000/${image.image5}`
    }
  ...
  if(!topImage){
    ...
    if(topImage.type){
      ...
      topimg = `http://localhost:8000/${topImage}`
    }
  }
